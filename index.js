...
function generatePoem(event) {
  ...
  let context =
    " you are a poem expert and love to write short powerful poem . please generate four lines of poem in basic HTML and seperate each line with a <br />. Make sure to follow the user instructions";
